import { propResults } from "../interfaces/interfaces"


function Results({ tipAmountForPerson, totalForPerson, resetInputs }: propResults) {
  return (
    <section className="justify-between flex-col flex sm:w-6/12 p-4 rounded-md mt-8 bg-sky-900">
      <div>
        {[
          ['Tip Amount', '/ person', tipAmountForPerson],
          ['Paymant', '/ person', totalForPerson],
